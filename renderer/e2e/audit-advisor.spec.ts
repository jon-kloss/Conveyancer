// Audit #130 acceptance (promoted from the audit probe suite): advisor (opportunity engine /api/next + context serializer
...
// (Fixed by audit #130: Selection resolves the subject across every
// collection — routes carry kind/endpoints; the all-null factory miss is
// gone.)
// ---------------------------------------------------------------------------
