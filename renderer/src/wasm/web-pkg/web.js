...
export class WebSession {
    ...
    dispatch(cmd, args) {
        ...
        const ret = wasm.websession_dispatch(this.__wbg_ptr, ptr0, len0, args);
        if (ret[2]) {
     ...
     */
    edit(cmds) {
        const ret = wasm.websession_edit(this.__wbg_ptr, cmds);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    export_blob() {
        const ret = wasm.websession_export_blob(this.__wbg_ptr);
     ...
     */
    hydrate() {
        const ret = wasm.websession_hydrate(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {Uint8Array | null} [docs_json]
     * @param {Uint8Array | null} [blob]
     */
    constructor(docs_json, blob) {
        var ptr0 = isLikeNone(docs_json) ? 0 : passArray8ToWasm0(docs_json, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(blob) ? 0 : passArray8ToWasm0(blob, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.websession_new(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     */
    next_moves() {
        const ret = wasm.websession_next_moves(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
